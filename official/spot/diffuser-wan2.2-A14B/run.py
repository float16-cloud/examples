...
transformer = AutoModel.from_pretrained("/share_weights/Wan2.2-T2V-A14B-Diffusers", subfolder="transformer", torch_dtype=torch.bfloat16,device_map = "cuda")
transformer_2 = AutoModel.from_pretrained("/share_weights/Wan2.2-T2V-A14B-Diffusers", subfolder="transformer_2", torch_dtype=torch.bfloat16,device_map = "cuda")
...
prompt = """Rocket exhaust plume creating artificial aurora."""
