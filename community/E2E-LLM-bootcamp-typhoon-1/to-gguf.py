...
if 'NO_LOCAL_GGUF' not in os.environ:
    sys.path.insert(1, '/share_weights/bootcamp/e2e-llm-typhoon-1/gguf-py/')
import gguf
...
class ModelBase:
    ...
    def write(self):
        ...
        self.gguf_writer.write_tensors_to_file(progress=False)
...
def main() -> None:
    ...
    with torch.inference_mode():
        ...
        print(f"Model written to {fname_out} complete.")
